...
`DXTabbedForm` / `DXBasicForm`, which renders `DXRepeater` for you. It is also
...
<PropsTable client:load props={[
  ...
  { name: 'field', type: 'FieldDefinition', required: 'Yes', default: '-', description: 'The repeater field definition. Provides sub-fields (field.fields), addLabel, minItems, maxItems.' },
