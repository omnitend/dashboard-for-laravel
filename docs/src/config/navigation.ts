...
export const navigationConfig: Navigation = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'DAccordionItem', url: '/components/base/DAccordionItem' },
      { label: 'DAlert', url: '/components/base/DAlert' },
      { label: 'DAspect', url: '/components/base/DAspect' },
      { label: 'DAutocomplete', url: '/components/base/DAutocomplete' },
      ...
      { label: 'DCarouselSlide', url: '/components/base/DCarouselSlide' },
      ...
      { label: 'DFormInvalidFeedback', url: '/components/base/DFormInvalidFeedback' },
      { label: 'DFormOtp', url: '/components/base/DFormOtp' },
      ...
      { label: 'DFormText', url: '/components/base/DFormText' },
      ...
      { label: 'DListGroupItem', url: '/components/base/DListGroupItem' },
      { label: 'DModal', url: '/components/base/DModal' },
      { label: 'DNav', url: '/components/base/DNav' },
      { label: 'DNavbar', url: '/components/base/DNavbar' },
      { label: 'DNavbarBrand', url: '/components/base/DNavbarBrand' },
      { label: 'DNavbarNav', url: '/components/base/DNavbarNav' },
      { label: 'DNavbarToggle', url: '/components/base/DNavbarToggle' },
      ...
      { label: 'DTab', url: '/components/base/DTab' },
